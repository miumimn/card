 ...
 *
 * NOTES:
 * - I updated all CTAs so none point to /onboarding per your request.
 * - They now route to /store (you can change them to /templates-preview if you prefer).
 */
...
` }} />
      ...
      <div className="handyman-page">
          ...
          <div className="hero-content" style={{ paddingTop: 28 }}>
            ...
            <div style={{ marginTop: 10 }}>
              <div className="cta-row" style={{ maxWidth: 760 }}>
                {/* changed to /store so no onboarding links */}
                <button className="btn btn-primary" onClick={() => router.push("/store")}>Request Visit / Book</button>
        ...
        <div className="preview-footer">
          ...
          {/* changed to /store so no onboarding links */}
          <button className="btn btn-primary" onClick={() => router.push("/store")}>Use this template</button>
        </div>
      </div>
    </>
  );
