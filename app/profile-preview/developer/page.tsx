  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        // build projects array if projects stored as text lines
        if (normalized.projects && Array.isArray(normalized.projects) && normalized.projects.length) {
          // leave as-is for the preview component to parse (it supports both structured and text)
        }
